...
//  MartinDemos
//
//  Created by Gao Huang on 15/7/10.
...
- (void)showIntroWithCrossDissolve {
    ...
    page1.bgImage = [UIImage imageNamed:@"testImg1"];
    ...
    page2.bgImage = [UIImage imageNamed:@"testImg1"];
    ...
    page3.bgImage = [UIImage imageNamed:@"testImg1"];
